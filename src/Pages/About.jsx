          ...
          <div className="w-full md:w-[50%] md:h-full flex items-center mt-100">
            <LazyMotion features={domAnimation} strict>
              ...
              >
                ...
                <span className="text-primary-700" style={{ fontSize: '0.95em', fontWeight: '500'}}>{introduction.text[1]}</span>
                <span className="text-primary-700" style={{ fontSize: '0.95em', fontWeight: '500'}}>{introduction.text[2]}</span>
                <span className="text-primary-700" style={{ fontSize: '0.95em', fontWeight: '500'}}>{introduction.text[3]}</span>
                <a href="" download>
